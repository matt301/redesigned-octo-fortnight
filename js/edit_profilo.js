function editBio()
{
    ...
    /* qui apri il file editBiografia.php e imposti il parametro asincrono=true                               */
    /* l'importanza di avere una comunicazione asincrona e' che JS non deve aspettare la risposta del server  */
    /* ma puo' continuare ad eseguire il codice ed eventualmente ritardare la risposta in attesa del server   */
    ...
    xmlhttp.open("GET","editBiografia.php",true);
    xmlhttp.send();
...
function editInfo()
{
    ...
    /* qui apri il file editInfo.php e imposti il parametro asincrono=true                                    */
    /* l'importanza di avere una comunicazione asincrona e' che JS non deve aspettare la risposta del server  */
    ...
    xmlhttp.open("GET","editInfo.php",true);
    xmlhttp.send();
